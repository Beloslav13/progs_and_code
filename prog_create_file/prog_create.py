...
def infs():
    messagebox.showinfo('Программа для создания файлов', 'Можно создать файл и записать в него первые строки. Если расширение файла не указано, по умолчанию файл создаеся как текстовый.')
